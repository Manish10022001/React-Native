...
export default function ErrorHandling() {
  ...
  return (
    ...
    //   <SafeAreaView style={styles.container}>
        ...
        //5.2 use error state to render appropriate ui to user
        <>
        {error ? (
        ...
        <View style={styles.inputContainer}>
            ...
            <Button 
                ...
                onPress={addPost} 
                disabled={isPosting || !postBody.trim() || !postTitle.trim()} //button disable if is posting in progress, body is empty or title is empty
                color="#007BFF" //it is forced 
            />
        </View>
